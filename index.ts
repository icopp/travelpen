...
export interface Travelpen {
  _logLevel: number
  _logCallback: Function | undefined
  _forceLogCallback: boolean
  _logs: any[]

  setCallback (callback: (logLevel: number, ...optionalParams: any[]) => void, force?: boolean, limit?: number): void
...
let travelpen: Travelpen = {
  _logLevel: 9,
  _logCallback: undefined,
  _forceLogCallback: false,
  _logs: [],
